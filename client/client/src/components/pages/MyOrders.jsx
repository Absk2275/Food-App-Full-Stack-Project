                    ...
                    .map((item) => {
                      return item.map((arrayData) => {
                        return arrayData.Order_date ? (
                          <div className='col-12' key={arrayData.Order_date}>
                          ...
                          <div className='col-12 col-md-6 col-lg-3'  key={arrayData.name}>
                            <div className='card mt-3 m-auto' style={{ width: "16rem", height: "250px" }}>
                              ...
                              <div className='card-body'>
                                ...
                                <div className='container w-100 p-0' style={{ height: "38px" }}>
                                  ...
                                  <button className='m-1 bg-secondary text-white rounded b-none'>{data}</button>
